namespace Atla.Compiler.Core.Semantics
...
module Analyze =
    ...
    let private resultToExpr (tid: TypeId) (span: Atla.Compiler.Core.Data.Span) (resolved: Result<Hir.Expr, string>) : Hir.Expr =
        match resolved with
        | Result.Ok expr -> expr
    ...
    let private unifyOrError (typeEnv: TypeEnv) (expected: TypeId) (actual: TypeId) (span: Atla.Compiler.Core.Data.Span) : Result<unit, Hir.Expr> =
